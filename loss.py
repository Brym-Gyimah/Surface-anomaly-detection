...
# Defining the preliminaries and the loss for the Structural Similarities Loss Function  
...
# Defining the preliminaries and the loss for the Gradient Magnitude Similarity Loss Function  
